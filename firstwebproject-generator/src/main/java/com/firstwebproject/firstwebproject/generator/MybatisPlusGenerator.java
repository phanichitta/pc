package com.firstwebproject.generator;
...
public class MybatisPlusGenerator {
    ...
    private static final String packageName = "com.firstwebproject";
    ...
    // 生成的分层代码
    enum LayerType {
        entity("/firstwebproject-model"),
        mapper("/firstwebproject-dao"),
        mapperxml("/firstwebproject-web"),
        service("/firstwebproject-service"),
        web("/firstwebproject-web"),
        ;
